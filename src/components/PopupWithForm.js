...
export class PopupWithForm extends Popup {
    constructor(popupSelector, submitFormHandler, openPopupHandler, openButtonHandler) {
        super(popupSelector);
    ...
    setEventListeners() {
        ...
        this._openButtonHandler.addEventListener('click', () => {
            this.open();
        }, false);
    }
}
